package com.practice.webstore.main;

import com.practice.webstore.dao.ProductDao;
import com.practice.webstore.daoimpl.ProductDaoImpl;
import com.practice.webstore.pojo.Admin;
import com.practice.webstore.pojo.Product;
import com.practice.webstore.pojo.User;
...
//			int opt = sc.nextInt();
            switch (opt){
                ...
                case 3:
                    System.out.println("Hello Eshika Please Verify Yourself......");
                    System.out.println("Enter Username");
                    String userName = sc.next();
